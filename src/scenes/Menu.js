class Menu extends Phaser.Scene {
    ...
    create() {
        ...
        this.add.text(game.config.width/2, game.config.height/2 - 25, 'Use ←↑↓→ to move', menuConfig).setOrigin(0.5);
        ...
        this.add.text(this.F.x, ASDF.y + 40, 'Press → to start', menuConfig).setOrigin(0.5);
        //-----------------------------------------------------------------------------------------------------------------------------
        //done with letters
        // define keys
